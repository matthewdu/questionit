...
gem 'jquery-rails' # Use jquery as the JavaScript librar
gem 'turbolinks' # Turbolinks makes following links in your web application faster. Read more: https://github.com/rails/turbolink
...
gem 'acts_as_votable', '~> 0.10.0' # voting
